...
function getDynamicWalkingPixel(lx, ly, direction, walkStep) {
    // Bobbing effect: shift head, torso, and belt DOWN by 1 pixel on steps 1 and 3
    ...
    if (walkStep === 1) {
        // Left step: left leg is lifted (shorter) and swung right
        leftLegXStart = 10;
        leftLegXEnd = 15;
        leftLegYMax = 41;
        // Right leg is straight and swung left
        rightLegXStart = 16;
        rightLegXEnd = 21;
    } else if (walkStep === 3) {
        // Right step: left leg is straight and swung right
        leftLegXStart = 9;
        leftLegXEnd = 14;
        // Right leg is lifted (shorter) and swung left
        rightLegXStart = 15;
        rightLegXEnd = 20;
        rightLegYMax = 41;
    }
...
// Generate Martin Spritesheet (128x192)
const martinPng = createPng(128, 192, (x, y) => {
...
console.log('Successfully generated dynamic walking spritesheet for Martin!');

...
export default class Inventory {
    ...
    toggle() {
        ...
        this.titleText = this.scene.add.text(width / 2, height / 2 - 70, "Inventario", {
            fontSize: "24px",
            color: "#ffffff",
            fontFamily: "monospace"
        }).setOrigin(0.5);
        this.itemsText = this.scene.add.text(width / 2, height / 2, this.items.length ? this.items.join(", ") : "Vacío", {
            fontSize: "18px",
            color: "#fcd34d",
            fontFamily: "monospace",
            wordWrap: { width: 280 }
